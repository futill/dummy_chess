...
class ArmMoveWithInput(Node):
    def __init__(self):
        ...
        self.commands = {
            ...
            "1": ([0.279, 0.005, 0.06], [1.0, 0.0, 0.0, 0.0]),
            "2": ([0.280, 0.043, 0.06], [1.0, 0.0, 0.0, 0.0]),
            "3": ([0.280, 0.075, 0.06], [1.0, 0.0, 0.0, 0.0]),
            "4": ([0.315, 0.007, 0.065], [1.0, 0.0, 0.0, 0.0]),
            "5": ([0.315, 0.045, 0.065], [1.0, 0.0, 0.0, 0.0]),
            "6": ([0.315, 0.075, 0.065], [1.0, 0.0, 0.0, 0.0]),
            "7": ([0.345, 0.08, 0.071], [1.0, 0.0, 0.0, 0.0]),
            "8": ([0.345, 0.045, 0.071], [1.0, 0.0, 0.0, 0.0]),
            "9": ([0.345, 0.009, 0.071], [1.0, 0.0, 0.0, 0.0])
        }
